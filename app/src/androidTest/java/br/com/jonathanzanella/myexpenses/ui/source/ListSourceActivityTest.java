...
import static br.com.jonathanzanella.myexpenses.ui.helpers.TestUtils.withRecyclerView;
...
public class ListSourceActivityTest {
	@Rule
	public ActivityTestRule<br.com.jonathanzanella.myexpenses.source.ListSourceActivity> activityTestRule = new ActivityTestRule<>(br.com.jonathanzanella.myexpenses.source.ListSourceActivity.class, true, false);
	...
	public void show_source_in_list() throws Exception {
		br.com.jonathanzanella.myexpenses.source.Source source = new SourceBuilder().build();
