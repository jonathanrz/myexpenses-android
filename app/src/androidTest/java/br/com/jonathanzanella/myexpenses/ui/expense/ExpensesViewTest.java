...
public class ExpensesViewTest {
	...
	private br.com.jonathanzanella.myexpenses.expense.Expense expense1;
	private br.com.jonathanzanella.myexpenses.expense.Expense expense2;
	...
	private ViewInteraction onViewExpenseName(br.com.jonathanzanella.myexpenses.expense.Expense expense) {
		return onView(allOf(
				withId(R.id.name),
				allOf(
