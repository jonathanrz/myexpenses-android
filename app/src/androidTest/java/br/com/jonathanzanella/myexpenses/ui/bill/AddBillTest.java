...
public class AddBillTest {
	...
	@Rule
	public ActivityTestRule<br.com.jonathanzanella.myexpenses.bill.EditBillActivity> editBillActivityTestRule = new ActivityTestRule<>(br.com.jonathanzanella.myexpenses.bill.EditBillActivity.class);
	...
	public void add_new_bill() throws InterruptedException {
		...
		String initDateText = br.com.jonathanzanella.myexpenses.bill.Bill.Companion.getSIMPLE_DATE_FORMAT().format(initDate.toDate());
		String endDateText = br.com.jonathanzanella.myexpenses.bill.Bill.Companion.getSIMPLE_DATE_FORMAT().format(endDate.toDate());
