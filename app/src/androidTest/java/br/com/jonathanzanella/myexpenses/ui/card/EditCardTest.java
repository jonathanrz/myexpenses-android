...
public class EditCardTest {
	@Rule
	public ActivityTestRule<br.com.jonathanzanella.myexpenses.card.ShowCardActivity> activityTestRule = new ActivityTestRule<>(br.com.jonathanzanella.myexpenses.card.ShowCardActivity.class, true, false);
	...
	@Inject
	br.com.jonathanzanella.myexpenses.card.CardRepository repository;

	private br.com.jonathanzanella.myexpenses.card.Card card;
	...
	public void edit_card_correctly() throws Exception {
		Intent i = new Intent();
		i.putExtra(br.com.jonathanzanella.myexpenses.card.ShowCardActivity.Companion.getKEY_CREDIT_CARD_UUID(), card.getUuid());
