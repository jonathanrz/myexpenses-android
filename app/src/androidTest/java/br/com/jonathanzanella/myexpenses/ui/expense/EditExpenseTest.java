...
public class EditExpenseTest {
	@Rule
	public ActivityTestRule<br.com.jonathanzanella.myexpenses.expense.ShowExpenseActivity> activityTestRule = new ActivityTestRule<>(br.com.jonathanzanella.myexpenses.expense.ShowExpenseActivity.class, true, false);

	private br.com.jonathanzanella.myexpenses.expense.Expense expense;
	@Inject
	...
	public void edit_expense_correctly() throws Exception {
		Intent i = new Intent();
		i.putExtra(br.com.jonathanzanella.myexpenses.expense.ShowExpenseActivity.Companion.getKEY_EXPENSE_UUID(), expense.getUuid());
